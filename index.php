            ...
            <div class="col-md-3 col-sm-6 mb-4">
                <div class="stat-card">
                    <div class="stat-number">
                        <?php 
                        $sellers = $db->fetchOne("SELECT COUNT(*) as count FROM users WHERE role = 'seller' AND status = 'active'");
                        echo $sellers['count'];
                        ?>+
                    </div>
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <div class="d-flex align-items-center mb-2">
                            <div class="rating me-2">
                                <?php for ($i = 1; $i <= 5; $i++){ ?>
                                <i class="fas fa-star <?php echo $i <= $rating['average'] ? 'star' : 'star empty'; ?>"></i>
                                <?php } ?>
                            </div>
...
<body class="home-page">
    ...
    <div class="home-banner">]
        <div class="container text-center">
            <h1 class="home-brand mb-4">Wearhouse</h1>
            <div class="container">
                <div class="row">
                    <div>
                        <a href="../views/store.php">Start Browsing</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col px-0">
