...
$seller = $db->fetchOne("SELECT CONCAT(users.first_name, ' ', users.last_name) AS fullname
                        FROM users
...
<div class="container">
    <div class="row">
        ...
        <div class="container">
            <h1>
                <span><h3><?php echo $product['brand']?></h3></span><?php echo $product['name'] ?? "Product Delisted";?>
            </h1>
